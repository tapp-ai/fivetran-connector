...
| ------------------- | -------------------------------------------------------------------------------------------------------- | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| `contacts`          | `[POST /v2/exports/contacts](https://docs.conversion.ai/api-reference/export-contacts)`                  | `id`        | One row per contact (lead). Every contact **field schema** is flattened in as a column keyed by its common name, e.g. `owner_id`, `first_name`. |
